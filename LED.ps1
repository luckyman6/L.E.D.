...
function DropBox-Upload 
{
    ...
    $DropBoxAccessToken = "ENTER DROPBOX FOLDER API AUTHORIZATION TOKEN"   # Replace with your DropBox Access Token. For more information read README.md
...
$done = New-Object -ComObject Wscript.Shell;$done.Popup("Files Uploaded.",1) # Replace message with the notification you want to appear at the end of the script.
